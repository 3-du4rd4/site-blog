...
export const FeatureSection = () => {
  return (
    <section className="container bg-gray-700 grid gap-6 md:grid-cols-2 pb-8 pt-8 md:px-10">
      <div className="bg-gray-500 flex flex-col gap-4 rounded-lg p-6 md:p-12">
      ...
      <div className="col-span-full flex flex-col gap-2">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 md:gap-4 rounded-lg bg-gray-500 p-6 md:p-12">
          <div className="flex flex-col gap-4">
            ...
            <Button
              asChild
              className="mt-4 w-fit rounded-full hidden md:mt-auto md:flex"
            >
          ...
          <div className="flex flex-col items-center justify-center w-full">
            ...
            <Button
              asChild
              className="mt-4 w-full gap-2 rounded-full md:hidden md:mt-auto"
            >
              <Link href="/criar-loja">
                Criar loja grátis
                <ArrowRight />
