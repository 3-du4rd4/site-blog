...
export const PostCard = ({
  ...
  return (
    <Link
      href={`/blog/${slug}`}
      className="w-full max-w-2xl rounded-xl border-2 border-gray-400 bg-gray-600 overflow-hidden transition all duration-300 hover:border-blue-300"
    >
      <div className="p-2 rounded-md overflow-hidden">
        ...
        <div className="px-2 mt-4 space-y-4">
          ...
          <p className="text-body-sm text-gray-100 line-clamp-3">
            {description}
          </p>
